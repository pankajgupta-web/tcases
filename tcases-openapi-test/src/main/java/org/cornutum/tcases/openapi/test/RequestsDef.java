 ...
 */
public class RequestsDef
{
    /**
     * Creates a new ResponsesDef instance.
     */
    public RequestsDef( ObjectNode root)
    {
        root_ = root;
    }

    public ObjectNode getRoots(){
        return root_;
    }
    /**
     ...
     */
    public RequestsDef forPaths( Collection<String> paths)
    {
     ...
     * If <CODE>paths</CODE> is null or empty, include all paths.
     */
    public RequestsDef forPaths( String... paths)
    {
     ...
     */
    public RequestsDef forOps( Collection<String> ops)
    {
        ObjectNode view = createObjectNode();
     ...
     * Returns a view of this ResponseDef that includes only the given API request operations.
     */
    public RequestsDef forOps( String... ops)
    {
     ...
     */
    public static void write( RequestsDef requests, Writer writer)
    {
        try( JsonGenerator generator = mapper().writerWithDefaultPrettyPrinter().createGenerator( writer))
        {
            mapper().writeTree( generator, requests.root_);
        }
        catch( Exception e)
        {
